...
int main(int argc, char* argv[]){
	...
	for(int i = 0; i < 4; i++){
		...
		fileName = "../../Data/Test Data/" + to_string(dataSize) + " Random Numbers.txt";
		of.open(fileName);
		...
		fileName = "../../Data/Test Data/" + to_string(dataSize) + " Reversed Sorted Numbers.txt";
		of.open(fileName);
		...
		fileName = "../../Data/Test Data/" + to_string(dataSize) + " 20 Percent Unique Numbers.txt";
		of.open(fileName);
        for(int j = 0; j < dataSize - 1; j++){
        	if(j < twentyPercent){
		...
		fileName = "../../Data/Test Data/" + to_string(dataSize) + " 30 Percent Randomized Numbers.txt";
		of.open(fileName);
        for(int j = 0; j < dataSize - 1; j++){
        	if((j % 3) == 0){
				of << rand() % dataSize << endl;
